...
def generate_m3u(channels: List[Dict[str, Any]]) -> str:
    ...
    m3u_content = '#EXTM3U url-tvg="https://arkina1234.github.io/iptv-streams/epg/rewardedtv.xml"\n'
...
def main():
    ...
    save_to_file('m3u/rewardedtv.m3u', m3u_content)
    
    # Generate XMLTV guide
    xml_content = generate_xml(data)
    save_to_file('epg/rewardedtv.xml', xml_content)
